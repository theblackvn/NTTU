...
/**
 * @ORM\Entity(repositoryClass="AMZ\ProfileBundle\Repository\SchoolYearRepository")
...
class SchoolYear
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="SchoolClass", mappedBy="schoolYear", fetch="EXTRA_LAZY")
     */
    private $classes;
