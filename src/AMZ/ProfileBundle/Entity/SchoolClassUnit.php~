...
/**
 * @ORM\Entity(repositoryClass="AMZ\ProfileBundle\Repository\SchoolClassUnitRepository")
 * @ORM\Table(name="school_class_unit")
 * @ORM\HasLifecycleCallbacks
 */
class SchoolClassUnit
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="SchoolClass", mappedBy="schoolClassUnit", fetch="EXTRA_LAZY")
     */
    private $classes;
